const searchHelper=(searchKey,query,req)=>{
   if(req.query.search){
    const searchObject={}; //aranan soru/cevap

    const regex=new RegExp(req.query.search,"i");
    searchObject[searchKey]=regex; //title degerine gore arama
...
const paginationHelper=async(totalDocuments,query,req)=>{
    ...
    return{
        ...
        startIndex ,
        limit //startIndex ve limit degerlerini answerlari ayirmak icin kullanacagiz
    };
